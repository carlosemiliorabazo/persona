...
public class Main {
    public static void main (String[] arg){
        ...
        System.out.println("Buenos dias : " + p.getNombre() + " " + p.getApellidos() + " con dni: " + String.valueOf(p.getDniSinLetra()) + " edad:" + String.valueOf(p.getEdad()) + " años " + "altura: " + String.valueOf(p.getAltura()) + "m");
